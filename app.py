...
# Vercel-এর জন্য ডাইরেক্টরি পাথ ফিক্স (যাতে ফাইল ইম্পোর্ট ও ফোল্ডার রিড করতে সমস্যা না হয়)
...
# ডাইনামিক ইম্পোর্ট (যাতে Pb2 ফোল্ডারে থাকুক বা সরাসরি রুট ডাইরেক্টরিতে, সব জায়গায় কাজ করে)
try:
    from Pb2 import MajorLogin_res_pb2
except ImportError:
    try:
...
# স্ট্যান্ডার্ড Flask অ্যাপ কনফিগারেশন - অ্যাবসোলিউট পাথ ব্যবহার করা হলো
app = Flask(__name__,
