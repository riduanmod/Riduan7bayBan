...
# Vercel Serverless পরিবেশের জন্য সঠিক ডিরেক্টরি পাথ নির্ধারণ
...
def index():
    try:
        ...
        return jsonify({'error': 'Template loading failed', 'details': str(e)}), 500
...
def ban_account():
    try:
        ...
        traceback.print_exc()
        return jsonify({'success': False, 'error': "সিস্টেমে একটি অপ্রত্যাশিত ত্রুটি ঘটেছে।"}), 500
