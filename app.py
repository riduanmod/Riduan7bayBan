...
# Protobuf ফাইল ইম্পোর্ট (মিসিং থাকলে ক্র্যাশ করবে না)
try:
...
def ban_account():
    # ফাইল মিসিং চেকিং
    if MajorLogin_res_pb2 is None:
        return jsonify({'success': False, 'error': 'Vercel সার্ভারে MajorLogin_res_pb2.py ফাইলটি নেই! দয়া করে এটি গিটহাবে আপলোড করুন।'}), 500
